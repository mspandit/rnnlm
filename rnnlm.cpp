...
int searchForValidationFile(int argc, char **argv, int debug_mode, char *valid_file, int &valid_data_set)
{
	int i = argPos((char *)"-valid", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
int setDebugMode(int argc, char **argv, int &debug_mode)
{ 
	//set debug mode
	int i = argPos((char *)"-debug", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
void setOneIter(int argc, char **argv, int debug_mode, int &one_iter)
{
	int i = argPos((char *)"-one-iter", argc, argv);
	if (i > 0) {
		one_iter = 1;
...
int setMaxIter(int argc, char **argv, int debug_mode, int &maxIter)
{
	int i = argPos((char *)"-max-iter", argc, argv);
	if (i > 0) {
...
void setNBest(int argc, char **argv, int debug_mode, int &nbest)
{
	if (argPos((char *)"-nbest", argc, argv) > 0) {
		nbest = 1;
		if (debug_mode > 0)
...
int searchForTestFile(int argc, char **argv, int debug_mode, int nbest, char *test_file, int &test_data_set)
{
	int i = argPos((char *)"-test", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
int setClassSize(int argc, char **argv, int debug_mode, int &class_size)
{
	int i = argPos((char *)"-class", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
void setOldClass(int argc, char **argv, int debug_mode, int &old_classes)
{
	if (argPos((char *)"-old-classes", argc, argv) > 0) {
		old_classes = 1;
...
int setLambda(int argc, char **argv, int debug_mode, float &lambda)
{
	int i = argPos((char *)"-lambda", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
int setGradientCutoff(int argc, char **argv, int debug_mode, float &gradient_cutoff)
{
	int i = argPos((char *)"-gradient-cutoff", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
int setDynamic(int argc, char **argv, int debug_mode, float &dynamic)
{
	int i = argPos((char *)"-dynamic", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
int setGen(int argc, char **argv, int debug_mode, int &gen)
{
	int i = argPos((char *)"-gen", argc, argv);
	if (i > 0) {
		if (i + 1 == argc) {
...
void setIndependent(int argc, char **argv, int debug_mode, int &independent)
{
	int i = argPos((char *)"-independent", argc, argv);
	if (i > 0) {
		independent = 1;
...
int main(int argc, char **argv)
{
	...
	if (0 == setMaxIter(argc, argv, debug_mode, maxIter))
		return 0;
	...
	setNBest(argc, argv, debug_mode, nbest);

	if (0 == searchForTestFile(argc, argv, debug_mode, nbest, test_file, test_data_set))
		return 0;
    
  if (0 == setClassSize(argc, argv, debug_mode, class_size))
		return 0;

	setOldClass(argc, argv, debug_mode, old_classes);
    
  if (0 == setLambda(argc, argv, debug_mode, lambda))
		return 0;

	if (0 == setGradientCutoff(argc, argv, debug_mode, gradient_cutoff))
		return 0;

	if (0 == setDynamic(argc, argv, debug_mode, dynamic))
		return 0;

	if (0 == setGen(argc, argv, debug_mode, gen))
		return 0;

	setIndependent(argc, argv, debug_mode, independent);
